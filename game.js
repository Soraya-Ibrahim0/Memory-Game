var main = document.getElementsByClassName("main")[0],
 ...
 var rArray = ['img/1.gif','img/3.gif','img/6.gif',
               'img/4.gif','img/10.gif','img/2.gif',
               'img/7.gif','img/8.gif','img/5.gif','img/9.gif',
               'img/1.gif','img/2.gif','img/3.gif',
               'img/6.gif','img/5.gif','img/4.gif',
               'img/9.gif','img/8.gif','img/7.gif','img/10.gif',
               ];
